...
class SessionManager:
    ...
    def __init__(
        ...
        # Storage paths
        self.entropic_dir = entropic_dir or (Path.home() / ".entropic")
        self.global_db_path = self.entropic_dir / "global.db"
        self.project_dir = self.entropic_dir / "projects" / self.project_id
