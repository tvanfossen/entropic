...
| REQ-LOOP-001 | Agent state machine with observable, dual-channel transitions | run_loop, run, run_turn, entropic_run_session, entropic_session_context_clear, entropic_session_drop |
...
**Total: 70 requirement(s) affected, 397 function(s) changed**
