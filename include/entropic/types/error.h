...
typedef enum {
    ...
    ENTROPIC_ERROR_MLOCK_LIMIT_EXCEEDED,      ///< use_mlock would pin more than RLIMIT_MEMLOCK allows for a model too large for the card; the pinned pages cannot be reclaimed, so set use_mlock: false (v2.13.0, gh#148)
} entropic_error_t;
