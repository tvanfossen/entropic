...
if TYPE_CHECKING:
    from entropic.core.directives import Directive
...
def load_tool_definition(
    ...
    Args:
        ...
        tools_dir: Base directory for tool JSON files. Defaults to
            entropic's bundled ``data/tools/``. Consumer apps pass their
...
class BaseMCPServer:
    ...
    **Override (legacy / complex servers):**
    ...
    def __init__(self, name: str, version: str = "1.0.0") -> None:
        ...
        from entropic.mcp.tools import ToolRegistry as _ToolRegistry
